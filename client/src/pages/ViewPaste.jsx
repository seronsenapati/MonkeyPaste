      ...
      <main className="flex-1 gradient-hero">
        <section className="relative overflow-hidden gradient-hero pt-24 pb-16 sm:pt-16 sm:pb-20 lg:py-24">
          ...
          <div className="container relative mx-auto px-4">
            <Card className="mx-auto max-w-2xl border-0 shadow-card bg-card/90 backdrop-blur-sm overflow-hidden animate-fade-in-up transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 hover:scale-[1.02]">
              <CardContent className="p-4 xs:p-6 sm:p-10">
                {loading ? (
                  ...
                  <div className="space-y-8 animate-scale-in">
                    ...
                    <div className="flex flex-col xs:flex-row xs:items-start justify-between gap-4">
                      <div className="flex items-center gap-3 xs:gap-4">
                        ...
                        <div>
                          <div>
                            <h1 className="text-xl xs:text-2xl font-black font-space-grotesk">
                              MonkeyPaste Shared
                            </h1>
                  ...
                  <div className="space-y-8 py-8 text-center animate-scale-in">
                    ...
                    <div>
                      <h2 className="text-2xl font-black mb-3 font-space-grotesk">
